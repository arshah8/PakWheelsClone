...
export default function hondacity (){
    return(
        <div className="grid grid-col-12 grid-row-12  justify-center w-full h-screen bg-zinc-100">
            ...
            <h1 className="font-bold text-3xl text-center text-black underline">Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</h1>
            
            <div className=" row-span-8 col-span-8 pl-[500px] pt-7 ">
            <Image
             src="/corolla.jpg"
             alt = "Corolla car in Red color"
             height={500}
             width= {350}
             className=""/>
            </div>
